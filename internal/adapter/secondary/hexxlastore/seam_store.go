...
// NewSeamStoreAdapter constructs a SeamStoreAdapter (caller owns DB lifecycle).
func NewSeamStoreAdapter(db *hexxladb.DB) *SeamStoreAdapter {
	return &SeamStoreAdapter{db: db}
}
