...
func RegisterTagBrowseTools(server *mcp.Server, svc primary.TagBrowse, log *slog.Logger, budget *RetrievalBudgetTracker) error {
	return registerTools(func() error {
