...
func RegisterTagBrowseTools(server *mcp.Server, svc primary.TagBrowse, log *slog.Logger) {
	...
	}, func(ctx context.Context, _ *mcp.CallToolRequest, _ struct{}) (*mcp.CallToolResult, domain.DistinctTagsResult, error) {
		if log != nil {
			log.Debug("mcp mosaic_hexxla_list_tags")
		}
		out, err := svc.ListDistinctTags(ctx)
		if err != nil {
	...
	}, func(ctx context.Context, _ *mcp.CallToolRequest, _ struct{}) (*mcp.CallToolResult, domain.TagCountsResult, error) {
		if log != nil {
			log.Debug("mcp mosaic_hexxla_tag_counts")
		}
		out, err := svc.TagCounts(ctx)
		if err != nil {
