...
- 2026-08-26: **Agent retrieval guidance** — documented lexical vs semantic/hybrid selection, normalized empty lexical results, and recommended tagged preference queries in the MCP blueprint.
...
- 2026-04-29: **Go module & build** — **`module github.com/sploitzberg/mosaic`**; removed legacy **`cmd/go-llm-project-structure`**; **`task build`** / CI pre-push build **`mosaic-mcp`**; **[`.goreleaser.yml`](.goreleaser.yml)** publishes **`mosaic-mcp`**.
